 ...
 *
 * NOTE: this project is intentionally kept flat (no /public or /Resources
 * folder), but for safety we still only expose the exact files the
 * browser needs (index.html, app.js, license.html) — never the whole
 * project directory — so source code and data files (config.js, mongo.js,
 * database.json, sessionSettings.json, etc.) are never served to visitors.
 */
...
app.get(['/license', '/license.html'], (req, res) => {
